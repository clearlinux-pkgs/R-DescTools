...
Version  : 0.99.32
Release  : 17
URL      : https://cran.r-project.org/src/contrib/DescTools_0.99.32.tar.gz
Source0  : https://cran.r-project.org/src/contrib/DescTools_0.99.32.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579277266
